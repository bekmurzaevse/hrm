...
class CreateRequest extends FormRequest
{
    ...
    /**
     * Summary of messages
     * @return array{deadline.string: string, description.string: string, project_id.exists: string, project_id.integer: string, project_id.required: string, requirements.required: string, requirements.string: string, reruiter_id.exists: string, reruiter_id.integer: string, reruiter_id.required: string, salary.numeric: string, status.in: string, status.string: string, title.required: string, title.string: string}
     */
    public function messages(): array
    {
        return [
            ...
            'reruiter_id.required' => "Recruiter id ma'jbu'riy!",
            'reruiter_id.integer' => "Recruiter id pu'tin tipte kiritiliwi kerek!",
            'reruiter_id.exists' => "Bunday user id bazada tabilmadi!",
